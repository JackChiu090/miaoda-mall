...
| Endpoint（单帧） | `POST https://app-cj6aqssgkd8h-api-VaOw5VAJdQBa-gateway.appmiaoda.com/v1/video_generation` |
| Endpoint（首尾帧） | `POST https://app-cj6aqssgkd8h-api-nYWNRQr5pV1L-gateway.appmiaoda.com/v1/video_generation` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-cj6aqssgkd8h-api-VaOw5VAJdQBa-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://${apiId}@app-cj6aqssgkd8h-api-VaOw5VAJdQBa-gateway.appmiaoda.com/v1/video_generation`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
