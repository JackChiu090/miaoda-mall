...
| Endpoint | `POST https://app-cj6aqssgkd8h-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-cj6aqssgkd8h-api-W9z3M74x6ZNL-gateway.appmiaoda.com` |
| 说明 | 用于向指定手机号发送短信验证码 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-cj6aqssgkd8h-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
