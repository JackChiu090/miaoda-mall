...
| Third-part Domain | `app-cj6aqssgkd8h-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com` |
| 计费 | 按次计费 |
...
| 端点 | `POST https://app-cj6aqssgkd8h-api-NLZ133Rnwr29-gateway.appmiaoda.com/precious-metal/inter/price` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-cj6aqssgkd8h-api-NLZ133Rnwr29-gateway.appmiaoda.com/precious-metal/inter/price",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
| 端点 | `POST https://app-cj6aqssgkd8h-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com/precious-metal/inter/kline` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-cj6aqssgkd8h-api-2Y00VV8Rkb2Y-gateway.appmiaoda.com/precious-metal/inter/kline",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
| 端点 | `POST https://app-cj6aqssgkd8h-api-nYWNRRkexgKL-gateway.appmiaoda.com/precious-metal/inter/contract` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-cj6aqssgkd8h-api-nYWNRRkexgKL-gateway.appmiaoda.com/precious-metal/inter/contract",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
