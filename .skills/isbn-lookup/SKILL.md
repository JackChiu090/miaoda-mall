...
- **Endpoint**：`POST https://app-cj6aqssgkd8h-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游接口 ---
  const url = new URL("https://app-cj6aqssgkd8h-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
