...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 城市限行查询 | POST | `https://app-cj6aqssgkd8h-api-pLVzAxRQyMWL-gateway.appmiaoda.com/vehiclelimit/query` |
| 获取支持限行查询的城市列表 | POST | `https://app-cj6aqssgkd8h-api-DYJwnJVBwb4a-gateway.appmiaoda.com/vehiclelimit/city` |
