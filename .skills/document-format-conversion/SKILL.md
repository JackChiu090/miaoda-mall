...
| 维度 | 说明 |
|------|------|
| 提交接口 | `POST https://app-cj6aqssgkd8h-api-rY7JZ6jqrneL-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/request` |
| 查询接口 | `POST https://app-cj6aqssgkd8h-api-oYA6ZGjReooa-gateway.appmiaoda.com/rest/2.0/ocr/v1/doc_convert/get_request_result` |
