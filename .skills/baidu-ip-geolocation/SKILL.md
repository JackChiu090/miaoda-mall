...
- **Endpoint**：`GET https://app-cj6aqssgkd8h-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = `https://app-cj6aqssgkd8h-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
