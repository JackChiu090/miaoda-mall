...
- **Endpoint**：`POST https://app-cj6aqssgkd8h-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-cj6aqssgkd8h-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
