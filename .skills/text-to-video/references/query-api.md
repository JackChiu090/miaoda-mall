...
| Endpoint | `GET https://app-cj6aqssgkd8h-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| 第三方域名 | `app-cj6aqssgkd8h-api-nYWNozBb5qML-gateway.appmiaoda.com` |
| 说明 | 仅用于查询任务状态 |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const queryUrl = new URL(
    "https://app-cj6aqssgkd8h-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video"
  );
