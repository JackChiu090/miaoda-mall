...
| 子系统 | 路径 | 说明 |
|--------|------|------|
| 管理后台（Web） | `/login`、`/dashboard` 等 | 覆盖用户、商品、订单、资金、分销、运营、招商考核、淘汰清理、拆人、权限、抢购时段、早市激励等 14 大业务域 |
...
- **管理后台**：数据仪表盘、用户管理、商品管理、订单管理、资金管理、分销管理、运营管理、招商考核、淘汰清理、拆单拆人、权限体系、抢购时段管理、早市商家分级激励、测试数据清除工具
